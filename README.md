...
<p align="center"><em>Dashboard de analytics de vendas — KPIs, tendências de receita e breakdown por canal</em></p>
<p align="center"><strong>API de dados → gráficos SVG feitos à mão → dashboard</strong></p>
