...
<p align="center"><em>Un dashboard limpio de analytics de ventas — KPIs, tendencias de ingresos y desglose por canal</em></p>
<p align="center"><strong>API de datos → gráficos SVG hechos a mano → dashboard</strong></p>
